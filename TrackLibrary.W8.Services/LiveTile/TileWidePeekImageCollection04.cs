...
{
    public class TileWidePeekImageCollection04 : ITileBase, ITileWide
    {
        ...
        public string ToXml()
        {
            string xml = String.Format(@"<tile>
                                        ...
                                        </tile>", Image01, Image01alt, Image02, Image02alt, Image03, Image03alt, Image04, Image04alt, Image05, Image05alt, Text01);
            return xml;
        }
    }
}
